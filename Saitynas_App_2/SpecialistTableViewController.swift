...
class SpecialistTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        viewModel = SpecialistTableViewModel()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = "\(specialist.firstName) \(specialist.lastName)"
...
//        let specialist = viewModel.getSpecialist(at: indexPath.row)
        if let viewController = storyboard?.instantiateViewController(.specialistDetailViewController) {
